...
namespace Beon.Models {
  public interface ITopicSubscriptionRepository {
    ...
    async void SubscribeAsync(int topicId, string userId) {
    ...
    async void SetNewCommentsAsync(int topicId) {
    ...
    async void UnsetNewCommentsAsync(int topicId, string userId) {

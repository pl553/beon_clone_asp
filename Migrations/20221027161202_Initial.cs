        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Discriminator = table.Column<string>(type: "TEXT", nullable: false),
                    TopicPostId = table.Column<int>(type: "INTEGER", nullable: true),
                    TopicOrd = table.Column<int>(type: "INTEGER", nullable: true),
                    Title = table.Column<string>(type: "TEXT", nullable: true),
                    UserDiaryId = table.Column<int>(type: "INTEGER", nullable: true),
                    ReadAccess = table.Column<int>(type: "INTEGER", nullable: true),
                    CommentAccess = table.Column<int>(type: "INTEGER", nullable: true),
                    Desires = table.Column<string>(type: "TEXT", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Posts_Diaries_UserDiaryId",
                        column: x => x.UserDiaryId,
                        principalTable: "Diaries",
                        principalColumn: "DiaryId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Posts_Posts_TopicPostId",
            ...
            migrationBuilder.CreateTable(
                name: "DiaryEntryCategories",
                columns: table => new
                {
                    DiaryEntryCategoryId = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    DiaryId = table.Column<int>(type: "INTEGER", nullable: false),
                    DiaryEntryPostId = table.Column<int>(type: "INTEGER", nullable: false),
                    Category = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DiaryEntryCategories", x => x.DiaryEntryCategoryId);
                    table.ForeignKey(
                        name: "FK_DiaryEntryCategories_Diaries_DiaryId",
                        column: x => x.DiaryId,
                        principalTable: "Diaries",
                        principalColumn: "DiaryId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DiaryEntryCategories_Posts_DiaryEntryPostId",
                        column: x => x.DiaryEntryPostId,
                        principalTable: "Posts",
                        principalColumn: "PostId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TopicPostId = table.Column<int>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TopicSubscriptions_Posts_TopicPostId",
                        column: x => x.TopicPostId,
                        principalTable: "Posts",
                        principalColumn: "PostId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DiaryEntryCategories_DiaryEntryPostId",
                table: "DiaryEntryCategories",
                column: "DiaryEntryPostId");

            migrationBuilder.CreateIndex(
                name: "IX_DiaryEntryCategories_DiaryId",
                table: "DiaryEntryCategories",
                column: "DiaryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Posts_TopicPostId",
                table: "Posts",
                column: "TopicPostId");

            migrationBuilder.CreateIndex(
                name: "IX_Posts_UserDiaryId",
                table: "Posts",
                column: "UserDiaryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TopicSubscriptions_TopicPostId",
                table: "TopicSubscriptions",
                column: "TopicPostId");
        }
